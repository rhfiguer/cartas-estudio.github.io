...
function flip(event){ 
    ...
    "¿Qué cualidad te importa en tus amigos?", "Cuéntanos dos cualidades tuyas", "¿Qué planes tienes para el fin de semana?",
    ...
    "¿Cómo se dice en español: Å FINNE - FORSTÅ - SKRIVE - HØRE - TENKE - LESE - SE PÅ ?", "¿Cómo se dice en español: Å MISTE - SPILLE - GÅ UT - HOPPE - JOBBE - KOMME", "¿Cómo se dice en español:Å TA MED - FØLE SEG - SETE NED - BETALE?"];
